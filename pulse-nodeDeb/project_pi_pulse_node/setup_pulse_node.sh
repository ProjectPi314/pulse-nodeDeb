...
echo -e "${GREEN}Performing distribution upgrade and cleaning up...${NC}"
...
# Ensure pip and venv for Python 3.10 are set up
echo -e "${GREEN}Ensuring pip and venv for Python 3.10 are set up...${NC}"
